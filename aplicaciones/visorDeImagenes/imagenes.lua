...
if imagenV == true and foto.pic != nil then
	...
	if menuIMG == false then
		...
		if controls.square() and controls.press("l") then foto.angulo = foto.angulo - 90 end
		if controls.square() and controls.press("r") then  foto.angulo = foto.angulo + 90 end
	...
	image.rotate(foto.pic,foto.angulo)
	image.factorscale(foto.pic,foto.escala)
	image.blit(foto.pic,foto.x,foto.y)
	if menuIMG == false then
